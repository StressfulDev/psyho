  ...
  return (
    ...
    >
      <div className="about-block">
        ...
        <p className="about-descr">
          {"Закончила международный институт SMART по направлениям практическая психология (развитие и самоопределение, отношения с другими людьми, принятие сложных решений, управление эмоциями) и клиническая психология (психические расстройства: тревожное, депрессивное расстройство, ОКР, БАР, ПТСР и др.)."}
        </p>
        <p className="about-descr">
